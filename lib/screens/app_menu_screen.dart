...
class AppMenuScreen extends BaseRoute {
  ...
  AppMenuScreen({super.analytics, super.observer, super.routeName = 'AppMenuScreen', this.onBackPressed, this.drawerKey});
  @override
            ...
            return Theme(
              ...
              child: CupertinoAlertDialog(
                ...
                actions: <Widget>[
                  ...
                  CupertinoDialogAction(
                    child: Text('${AppLocalizations.of(context)!.btn_logout}', style: TextStyle(color: Colors.red)),
                    onPressed: () async {
